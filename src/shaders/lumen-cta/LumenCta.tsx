...
export function LumenCta({
  ...
  style,
  ...buttonProps
}: LumenCtaProps & Omit<React.ButtonHTMLAttributes<HTMLButtonElement>, "type" | "onClick" | "disabled">) {
  ...
  return (
    ...
    >
      <button
        className={`lumen-cta__button${safeVariant === "ghost" ? " lumen-cta__button--ghost" : ""}${buttonClassName ? ` ${buttonClassName}` : ""}`}
        type={type}
        disabled={disabled}
        onClick={onClick}
        {...buttonProps}
